...
import { Bolt, Check, CheckCircle, Mail, XCircle } from '../components/shared/Icons.js';
    ...
    <div style={{
      ...
      <div style={{ width:'100%', maxWidth:460, position:'relative', zIndex:1 }}>
        ...
        <div style={{ textAlign:'center', marginBottom:28 }}>
          <div style={{ width:52, height:52, borderRadius:14, margin:'0 auto 12px', background:'linear-gradient(135deg,#7c3aed,#a855f7)', display:'flex', alignItems:'center', justifyContent:'center' }}><Bolt size={26}/></div>
        ...
        <div className="glass-card" style={{ padding:36, textAlign:'center' }}>
          ...
          {status === 'ready' && (
            <>
              <div style={{ marginBottom:16, color:"var(--purple-light)" }}><CheckCircle size={52}/></div>
              ...
              >
                {accepting ? '⏳ Accepting...' : <><Check size={14}/> Accept Invitation</>}
              </button>
          ...
          {status === 'success' && (
            <>
              <div style={{ fontSize:52, marginBottom:16 }}><CheckCircle size={40}/></div>
              <h2 style={{ fontSize:22, fontWeight:800, color:'var(--text-primary)', margin:'0 0 10px' }}>
                Welcome to the Team!
              </h2>
              {orgInfo && (
          ...
          {status === 'wrong-email' && (
            <>
              <div style={{ fontSize:52, marginBottom:16 }}><Mail size={40}/></div>
          ...
          {status === 'error' && (
            <>
              <div style={{ fontSize:52, marginBottom:16 }}><XCircle size={40}/></div>
              <h2 style={{ fontSize:20, fontWeight:800, color:'var(--text-primary)', margin:'0 0 10px' }}>
                Invitation Invalid
              </h2>
              <div style={{ padding:'12px 16px', borderRadius:10, background:'rgba(239,68,68,0.08)', border:'1px solid rgba(239,68,68,0.25)', marginBottom:20, fontSize:13, color:'#ef4444', lineHeight:1.6 }}>

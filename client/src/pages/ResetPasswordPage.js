...
import { AlertTriangle, Bolt, Check, CheckCircle, Lock, XCircle } from '../components/shared/Icons.js';
        ...
        <div className="glass-card" style={{ padding:36 }}>
          ...
          {status === 'error' && (
            <div style={{ textAlign:'center' }}>
              <div style={{ fontSize:48, marginBottom:14 }}><XCircle size={40}/></div>
          ...
          {status === 'ready' && (
            <>
              <div style={{ textAlign:'center', marginBottom:24 }}>
                <div style={{ fontSize:44, marginBottom:12 }}><Lock size={36}/></div>
              ...
              <form onSubmit={handleReset}>
                ...
                <button type="submit" className="btn-primary"
                  ...
                  {loading ? '⏳ Updating...' : <><Check size={14}/> Set New Password</>}
                </button>
              </form>
            </>
          )}
